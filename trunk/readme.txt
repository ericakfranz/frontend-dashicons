...
Load the [Dashicons icon font](https://developer.wordpress.org/resource/dashicons/) on the front-end of your site.
...
Activate and you're ready to start using Dashicons on the front-end of your site via HTML and CSS.
...
This plugin *does not* provide shortcode functionality to implement Dashicon icons throughout your site. Instead you should refer to the official [Dashicons documentation](https://developer.wordpress.org/resource/dashicons/) to add icons using HTML and/or CSS.
